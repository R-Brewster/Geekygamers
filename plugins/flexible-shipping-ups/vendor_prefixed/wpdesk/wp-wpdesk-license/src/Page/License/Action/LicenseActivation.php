...
use UpsFreeVendor\WPDesk\License\ServerAddressRepository;
...
class LicenseActivation implements \UpsFreeVendor\WPDesk\License\Page\Action
{
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \UpsFreeVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \UpsFreeVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
